...
export const metadata: Metadata = {
  ...
  description:
    "Professional home inspection services in West Palm Beach, FL. 4-point, wind mitigation, buyer's & pre-listing inspections. InterNACHI certified.",
  openGraph: {
    title: "Home Inspector in West Palm Beach, FL",
    description:
      "Professional home inspection services in West Palm Beach, FL. 4-point, wind mitigation, buyer's & pre-listing inspections. InterNACHI certified.",
    url: "https://integrity1-home-inspections.vercel.app/areas/west-palm-beach",
  },
};
