...
export const metadata: Metadata = {
  title: "Home Inspector in Boca Raton, FL",
  description:
    "Professional home inspection services in Boca Raton, FL. 4-point, wind mitigation, buyer's & pre-listing inspections. InterNACHI certified.",
  openGraph: {
    title: "Home Inspector in Boca Raton, FL",
    description:
      "Professional home inspection services in Boca Raton, FL. 4-point, wind mitigation, buyer's & pre-listing inspections. InterNACHI certified.",
    url: "https://integrity1-home-inspections.vercel.app/areas/boca-raton",
  },
};
