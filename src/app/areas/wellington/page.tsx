...
export const metadata: Metadata = {
  title: "Home Inspector in Wellington, FL | Integrity1 Home Inspections",
  description:
    "Professional home inspection services in Wellington, FL. 4-point, wind mitigation, buyer's & pre-listing inspections. 5-star rated, InterNACHI certified. Call (561) 565-8513.",
};
